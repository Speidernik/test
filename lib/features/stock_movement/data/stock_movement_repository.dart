    ...
    StockMovement(
      ...
      items: [
        StockMovementItem(
          ...
          quantity: 24, barcode: 'BC4421001',
        ),
        StockMovementItem(
          id: 'i2', sku: 'SKU-8832',
          description: 'Red Container 1L',
          quantity: 12, barcode: 'BC8832002',
        ),
        StockMovementItem(
          id: 'i3', sku: 'SKU-1156',
          description: 'Yellow Drum 5L',
          quantity: 6, barcode: 'BC1156003',
        ),
      ],
    ),
    StockMovement(
      ...
      items: [
        StockMovementItem(
          ...
          quantity: 48, barcode: 'BC3310004',
        ),
        StockMovementItem(
          id: 'i5', sku: 'SKU-7790',
          description: 'Foam Packing Sheet',
          quantity: 100, barcode: 'BC7790005',
        ),
      ],
    ),
    StockMovement(
      ...
      items: [
        StockMovementItem(
          ...
          quantity: 4, barcode: 'BC9901006',
          isConfirmed: true, scannedBarcode: 'BC9901006',
        ),
      ],
    ),
    StockMovement(
      ...
      items: [
        StockMovementItem(
          ...
          quantity: 60, barcode: 'BC2245007',
        ),
        StockMovementItem(
          id: 'i8', sku: 'SKU-6612',
          description: 'Cork Stopper Set (100)',
          quantity: 3, barcode: 'BC6612008',
        ),
        StockMovementItem(
          id: 'i9', sku: 'SKU-5501',
          description: 'Label Roll A4',
          quantity: 10, barcode: 'BC5501009',
        ),
        StockMovementItem(
          id: 'i10', sku: 'SKU-3388',
          description: 'Shrink Wrap 500m',
          quantity: 5, barcode: 'BC3388010',
        ),
      ],
    ),
  ];
